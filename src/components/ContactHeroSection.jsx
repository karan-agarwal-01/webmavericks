    ...
    return (
        ...
        >            
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                ...
                <div ref={orb1Ref} className="absolute -top-20 -left-20 w-31.25 h-31.25 rounded-full bg-lime-500 blur-[120px] z-10 opacity-80"></div>
                <div ref={orb2Ref} className="absolute -bottom-40 -right-20 w-37.5 h-37.5 rounded-full bg-amber-400 blur-[120px] z-10 opacity-60"></div>
                <div ref={orb3Ref} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-25 h-25 rounded-full bg-rose-500 blur-[100px] z-10 opacity-40"></div>
            ...
            <div className="absolute inset-0 z-10 pointer-events-none hidden md:block max-w-7xl mx-auto w-full">
                <div ref={shape1Ref} className="absolute top-[25%] left-[10%] w-16 h-16 border-2 border-purple-500/30 rounded-full backdrop-blur-md"></div>
                <div ref={shape1Ref} className="absolute bottom-[30%] left-[5%] w-12 h-12 bg-rose-500/20 border-none blur-[2px] rounded-full backdrop-blur-md"></div>
                <div ref={shape2Ref} className="absolute bottom-[20%] left-[18%] w-24 h-24 bg-linear-to-br from-blue-500/10 to-transparent border border-white/5 backdrop-blur-sm rounded-xl rotate-12"></div>
                <div ref={shape3Ref} className="absolute top-[20%] right-[15%] w-12 h-12 bg-rose-500/20 rounded-full blur-[2px]"></div>
                ...
                <div ref={shape1Ref} className="absolute top-[35%] right-[20%] w-16 h-16 border-2 border-purple-500/30 rounded-full backdrop-blur-md"></div>
            </div>
