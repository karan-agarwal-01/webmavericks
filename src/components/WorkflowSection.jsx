...
const workflowData = [
    {
        ...
        description: "Ensure your goals are Specific, Measurable, Achievable, Relevant, and Time-bound.",
    },
    {
        id: "02",
        title: "Conduct Market Research",
        description: "Understand your target audience's demographics, interests, and behavior.",
    },
    {
        id: "03",
        title: "Develop a Strategy",
        description: "Plan what type of content you will create, including blog posts, videos, social media posts, etc.",
    },
    {
        id: "04",
        title: "Create a Plan and Timeline",
        description: "Outline all tasks and assign responsibilities to ensure smooth execution.",
    },
];
                        ...
                        {workflowData.map((step, index) => (
                            ...
                            >
                                <div className="flex flex-row lg:flex-col items-start lg:items-center">
                                    <div className="flex flex-col items-center mr-8 lg:mr-0 lg:mb-12 relative z-20">
                                    ...
                                    <div className="bg-white rounded-2xl p-12 border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 flex-1 relative overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <h3 className="text-xl md:text-xl font-semibold text-slate-800 mb-4 group-hover:text-slate-950 transition-colors duration-300">
                                                {step.title}
                                            </h3>
